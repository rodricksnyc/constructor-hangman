...
tap.test('pause/resume incoming', function (t) {
  ...
  let expect = [PAUSE, RESUME, PAUSE, RESUME]
  str.pipe(ms)
  ms.pause()
  ms.resume()
  ms.pause()
...
tap.test('replace with *', function (t) {
  let str = new PassThrough
  let ms = new MS({replace: '*'})
  str.pipe(ms)
  let expect = ['foo', '*****', 'bar', '***', 'baz', 'boo', '**', '****']
...
tap.test('replace with ~YARG~', function (t) {
  let str = new PassThrough
  let ms = new MS({replace: '~YARG~'})
  str.pipe(ms)
  let expect = ['foo', '~YARG~~YARG~~YARG~~YARG~~YARG~', 'bar',
