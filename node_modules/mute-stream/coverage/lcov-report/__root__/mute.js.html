...
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">let Stream = require('stream')
&nbsp;
module.exports = MuteStream
&nbsp;
// let out = new MuteStream(process.stdout)
// argument auto-pipes
...
<span class="cstat-no" title="statement not covered" >  let d = this._dest</span>
<span class="cstat-no" title="statement not covered" >  let s = this._src</span>
