...
vows.describe('utile').addBatch({
  "When using utile": {
    ...
    "the mixin() method": function () {
      let mixed = utile.mixin({}, obj1, obj2);
    ...
    "the escapeRegExp() method": function () {
      let ans = "\\/path\\/to\\/resource\\.html\\?search=query";
    ...
    "the underscoreToCamel() method": function () {
      let obj = utile.underscoreToCamel({
        key_with_underscore: {
          andNested: 'values',
          several: [1, 2, 3],
    ...
    "the camelToUnderscore() method": function () {
      let obj = utile.camelToUnderscore({
        keyWithCamel: {
          andNested: 'values',
          several: [1, 2, 3],
          nestedCamel: true
