...
let equal = require('../');
let isArguments = require('../lib/is_arguments.js');
let objectKeys = require('../lib/keys.js');
...
test('dates', function (t) {
    let d0 = new Date(1387585278000);
    let d1 = new Date('Fri Dec 20 2013 16:21:18 GMT-0800 (PST)');
    t.ok(equal(d0, d1));
    t.end();
});
