(function (exports) {
  ...
  function validateObject(object, schema, options, errors) {
    let props, allProps = Object.keys(object),
        visitedProps = [];
    ...
    if (undefined !== schema.additionalProperties) {
      ...
      let unvisitedProps = allProps.filter(function(k){
  ...
  function error(attribute, property, actual, schema, errors) {
    let lookup = { expected: schema[attribute], actual: actual, attribute: attribute, property: property };
