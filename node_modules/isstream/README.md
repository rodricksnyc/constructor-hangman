...
```js
let isReadable = require('isstream').isReadable
let isWritable = require('isstream').isWritable
let isDuplex = require('isstream').isDuplex
let Stream = require('stream')
