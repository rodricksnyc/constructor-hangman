...
describe('ncp', function () {
  describe('regular files and directories', function () {
    let fixtures = path.join(__dirname, 'regular-fixtures'),
  ...
  describe('symlink handling', function () {
    let fixtures = path.join(__dirname, 'symlink-fixtures'),
        src = path.join(fixtures, 'src'),
        out = path.join(fixtures, 'out');
  ...
  describe('broken symlink handling', function () {
    let fixtures = path.join(__dirname, 'broken-symlink-fixtures'),
        src = path.join(fixtures, 'src'),
        out = path.join(fixtures, 'out');
  ...
  describe('modified files copies', function () {
      let fixtures = path.join(__dirname, 'modified-files'),
          src = path.join(fixtures, 'src'),
          out = path.join(fixtures, 'out');
