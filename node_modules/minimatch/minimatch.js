...
function parse (pattern, isSub) {
  ...
  for (let i = 0, len = pattern.length, c
    ...
    switch (c) {
      ...
      case ']':
        ...
        if (inClass) {
          ...
          let cs = pattern.substring(classStart + 1, i)
          try {
            RegExp('[' + cs + ']')
          } catch (er) {
            // not a valid class!
            let sp = this.parse(cs, SUBPARSE)
  ...
  try {
    let regExp = new RegExp('^' + re + '$', flags)
  } catch (er) {
