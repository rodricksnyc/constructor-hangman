(function() {
  ...
  vows.describe('Module Inflector methods').addBatch({
    'Test inflector method': {
      ...
      'camelize': {
        'word': function(topic) {
          let i, words, _i, _len, _ref, _results;
      ...
      'underscore': {
        'word': function(topic) {
          let i, words, _i, _j, _len, _len2, _ref, _ref2, _results;
          words = cases.CamelToUnderscore;
          _ref = Object.keys(words);
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            i = _ref[_i];
    ...
    'Test inflector inflection methods': {
      ...
      'uncountablility': {
        'normal': function(topic) {
          let i, words, _i, _j, _k, _len, _len2, _len3, _results;
        ...
        'greedy': function(topic) {
          let countable_word, uncountable_word;
