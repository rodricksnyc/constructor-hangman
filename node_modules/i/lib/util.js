...
let u = module.exports = {
  ...
  string: {
    ...
    //
    // In the function form, the current match object is passed in as a parameter to the function, and letiables such as
    ...
    gsub: function (str, pattern, replacement) {
      let i, match, matchCmpr, matchCmprPrev, replacementStr, result, self;
    ...
    //     "hello".upcase #=> "Hello"
    upcase: function(str) {
      let self = u.string.gsub(str, /_([a-z])/, function ($) {
