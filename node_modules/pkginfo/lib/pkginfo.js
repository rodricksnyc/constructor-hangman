...
//
let pkginfo = module.exports = function (pmodule, options) {
  let args = [].slice.call(arguments, 2).filter(function (arg) {
    return typeof arg === 'string';
  });

  //
  // **Parse letiable arguments**
  //
  ...
  let pkg = pkginfo.read(pmodule, options.dir).package;
